...
import com.test.catalog.api.CourseView;
import com.test.catalog.api.CoursesApi;
import com.test.common.error.ConflictException;
import com.test.common.error.NotFoundException;
import com.test.common.event.DomainEventPublisher;
import com.test.enrollments.api.event.EnrollmentCreatedEvent;
