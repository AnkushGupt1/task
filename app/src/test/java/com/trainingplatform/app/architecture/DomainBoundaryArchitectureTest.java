package com.trainingplatform.app.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.trainingplatform", importOptions = ImportOption.DoNotIncludeTests.class)
class DomainBoundaryArchitectureTest {
    ...
    static final ArchRule cores_do_not_depend_on_each_other = slices()
            .matching("com.trainingplatform.(*).core..")
    ...
    static final ArchRule api_modules_are_framework_free = noClasses()
            .that().resideInAPackage("com.trainingplatform..api..")
    ...
    static final ArchRule entities_stay_inside_core = classes()
            ...
            .should().resideInAPackage("com.trainingplatform..core..")
